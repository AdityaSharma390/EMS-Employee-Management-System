...
export const payrollSchema = z.object({
  ...
  bonus: z.coerce.number().min(0, "Bonus must be 0 or greater").default(0),
  deductions: z.coerce.number().min(0, "Deductions must be 0 or greater").default(0),
  ...
  year: z.coerce.number().min(2000, "Year must be 2000 or greater"),
});
